...
class NotesService {
  ...
  // Stream Controller for our Notes Service
  ...
  // Allows other methods to open up the database without having to
  // explicitly call it in the initState method.
...
const noteTable = 'note'; // Fixed note table label
